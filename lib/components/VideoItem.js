...
var styles = _aphrodite.StyleSheet.create({
  ...
  iframe: (_iframe = {
    ...
    top: 0,
    right: 0
  }, _defineProperty(_iframe, 'width', 'inherit'), _defineProperty(_iframe, 'height', '100%'), _defineProperty(_iframe, 'maxHeight', 'inherit'), _defineProperty(_iframe, 'margin', 'auto'), _iframe)
});
